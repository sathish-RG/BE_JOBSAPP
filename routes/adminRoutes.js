...
adminRouter.put('/recruiter', auth.checkAuth,auth.allowRoles(['admin']),adminController.updateRecruiter);
adminRouter.delete('/recruiter', auth.checkAuth,auth.allowRoles(['admin']),adminController.deleteRecruiter);
...
adminRouter.delet('/companies/:id', auth.checkAuth,auth.allowRoles(['admin']),adminController.deleteCompany);
...
adminRouter.put('/companies/:companyId/assign-recruiter/:recruiterId',auth.checkAuth,auth.allowRoles(['admin']),adminController.removeRecruiter);
